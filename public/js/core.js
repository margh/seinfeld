...
var CalCtrl, app, getMonthArray, moment, twix;
...
app.controller('calCtrl', CalCtrl = (function() {
  function CalCtrl() {
    this.days = getMonthArray();
    window.day = this.days[0];
  }
