...
var CalCtrl, Day, app, getMonthArray, moment, twix;
...
Day = (function() {
  function Day(props) {
    ...
    this.moment = moment(this.dateString, 'DD-MM-YYYY');
  }
...
app.controller('calCtrl', [
  '$http', CalCtrl = (function() {
    function CalCtrl(http) {
      var cal;
      cal = this;
      this.days = [];
      http.get('./december.json').success(function(data) {
        var day, _fn, _i, _len;
        _fn = function(day) {
          return cal.days.push(new Day(day));
        };
        for (_i = 0, _len = data.length; _i < _len; _i++) {
          day = data[_i];
          _fn(day);
        }
        return window.day = cal.days[0];
      });
    }
...
},{"moment":"/Users/nathan/seinfeld/node_modules/moment/moment.js","twix":"/Users/nathan/seinfeld/node_modules/twix/bin/twix.js"}],"/Users/nathan/seinfeld/node_modules/moment/moment.js":[function(require,module,exports){
(function (global){
//! moment.js
//! version : 2.7.0
