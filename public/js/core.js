...
var AuthenticationService, CalendarController, DayService, LoginController, RegisterController, app;
...
},{"./controllers/calendarController":"/Users/nathan/seinfeld/src/client/controllers/calendarController.coffee","./controllers/loginController":"/Users/nathan/seinfeld/src/client/controllers/loginController.coffee","./controllers/registerController":"/Users/nathan/seinfeld/src/client/controllers/registerController.coffee","./services/authenticationService":"/Users/nathan/seinfeld/src/client/services/authenticationService.coffee","./services/dayService":"/Users/nathan/seinfeld/src/client/services/dayService.coffee"}],"/Users/nathan/seinfeld/node_modules/moment/moment.js":[function(require,module,exports){
(function (global){
//! moment.js
//! version : 2.7.0
...
},{}],"/Users/nathan/seinfeld/node_modules/twix/bin/lang.js":[function(require,module,exports){
...
},{}],"/Users/nathan/seinfeld/node_modules/twix/bin/twix.js":[function(require,module,exports){
// Generated by CoffeeScript 1.7.1
(function() {
...
},{"./lang":"/Users/nathan/seinfeld/node_modules/twix/bin/lang.js","moment":"/Users/nathan/seinfeld/node_modules/moment/moment.js"}],"/Users/nathan/seinfeld/node_modules/underscore/underscore.js":[function(require,module,exports){
//     Underscore.js 1.6.0
...
},{}],"/Users/nathan/seinfeld/src/client/controllers/calendarController.coffee":[function(require,module,exports){
var CalendarController, Day, getDates, moment, twix, _,
...
module.exports = CalendarController = (function() {
  function CalendarController(dayService) {
    this.response = __bind(this.response, this);
    this.enterDay = __bind(this.enterDay, this);
    this.getDays = __bind(this.getDays, this);
    this.service = dayService;
    window.m = moment();
    this.days = _.map(getDates(), function(dateObj) {
      return new Day({
        moment: dateObj,
  ...
  CalendarController.prototype.getDays = function() {
    var cal;
    cal = this;
    return this.service.getDays(function(e, dayList) {
      var dayData, _i, _len, _results;
      if (e) {
        return false;
      }
      _results = [];
      for (_i = 0, _len = dayList.length; _i < _len; _i++) {
        dayData = dayList[_i];
        _results.push((function(dayData) {
          var displayDay;
          displayDay = _.findWhere(cal.days, {
            dateString: dayData.dateString
          });
          if (displayDay) {
            return displayDay.checked = dayData.checked;
          }
        })(dayData));
      }
      return _results;
  ...
  CalendarController.prototype.enterDay = function(day) {
    day.toggle();
    return this.service.enterDay(day, this.response);
  };

  CalendarController.prototype.response = function(e) {
    if (e) {
      console.log('do something about errros');
    }
...
},{"./../models/day":"/Users/nathan/seinfeld/src/client/models/day.coffee","moment":"/Users/nathan/seinfeld/node_modules/moment/moment.js","twix":"/Users/nathan/seinfeld/node_modules/twix/bin/twix.js","underscore":"/Users/nathan/seinfeld/node_modules/underscore/underscore.js"}],"/Users/nathan/seinfeld/src/client/controllers/loginController.coffee":[function(require,module,exports){
var LoginController,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

module.exports = LoginController = (function() {
  ...
  LoginController.prototype.submit = function() {
    ...
    return this.service.login(login, this.success, this.fail);
  };

  LoginController.prototype.success = function(user) {
    this.reset();
    this.authenticated = true;
    return this.username = user.username;
  };

  LoginController.prototype.fail = function(e) {
...
},{}],"/Users/nathan/seinfeld/src/client/controllers/registerController.coffee":[function(require,module,exports){
var LoginController,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
module.exports = LoginController = (function() {
  ...
  LoginController.prototype.submit = function() {
    ...
    return this.service.register(registration, this.response);
  };

  LoginController.prototype.response = function(e) {
    if (e) {
      console.log('do something about errros');
    }
    return console.log('good jaaaaab');
  };
...
},{}],"/Users/nathan/seinfeld/src/client/models/day.coffee":[function(require,module,exports){
var Day, moment, twix,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
},{"moment":"/Users/nathan/seinfeld/node_modules/moment/moment.js","twix":"/Users/nathan/seinfeld/node_modules/twix/bin/twix.js"}],"/Users/nathan/seinfeld/src/client/services/authenticationService.coffee":[function(require,module,exports){
var errorHandler;
...
module.exports = [
  '$http', '$cookies', function($http, $cookies) {
    ...
    return new (AuthenticationService = (function() {
      ...
      AuthenticationService.prototype.profile = function(success, fail) {
        return $http.get('/profile').success(success).fail(fail);
      };

      AuthenticationService.prototype.register = function(registrationData, cb) {
        return $http.post('/users', registrationData).success(function(res) {
          return cb(null, res);
        }).error(errorHandler);
      };

      AuthenticationService.prototype.login = function(loginData, success, fail) {
        console.log(loginData);
        return $http.post('/login', loginData).success(success).error(fail);
      };

      AuthenticationService.prototype.logout = function(cb) {
...
},{}],"/Users/nathan/seinfeld/src/client/services/dayService.coffee":[function(require,module,exports){
var errorHandler;
...
module.exports = [
  '$http', function($http) {
    var DayService;
    return new (DayService = (function() {
      function DayService() {}

      DayService.prototype.getDays = function(cb) {
        return $http.get('/days/all').success(function(res) {
          return cb(null, res);
        }).error(errorHandler);
      };

      DayService.prototype.enterDay = function(day, cb) {
        return $http.post("/days/" + day.dateString, day).success(function(res) {
          return cb(null, res);
        }).error(errorHandler);
      };
