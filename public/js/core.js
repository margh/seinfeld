...
module.exports = LoginController = (function() {
  ...
  LoginController.prototype.response = function(e) {
    ...
    return console.log('logged innnn');
  };
...
module.exports = LoginController = (function() {
  function LoginController(service) {
    ...
    this.passwordsMatch = __bind(this.passwordsMatch, this);
    this.model = {
      email: 'nathan@admin',
      password: 'administration',
  ...
  LoginController.prototype.passwordsMatch = function() {
